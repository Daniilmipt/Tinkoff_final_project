...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf()
                ...
                .antMatchers(HttpMethod.DELETE, "/travel").hasAnyRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/travel").hasAnyRole("ADMIN", "USER")
                .antMatchers(HttpMethod.GET, "/travel/basket").hasAnyRole("ADMIN", "USER")
                .antMatchers(HttpMethod.GET, "/travel").permitAll()
                .antMatchers(HttpMethod.GET, "/travel/user/basket").hasAnyRole("ADMIN")
                .and()
                .exceptionHandling()
                .authenticationEntryPoint(authEntryPoint)
                .and()
